...
import 'package:attributes_client/common/apifunctions/requestRegisterAPI.dart';
...
class RegisterScreenState extends State<RegisterScreen> {
  ...
  final FocusNode _verifyPasswordNode = FocusNode();
  ...
  void initState() {
    super.initState();
    _saveCurrentRoute("/RegisterScreen");
  }
                  ...
                  child: RichText(
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text:
                              'Sign up here to complete attribute activities and save them to your account.',
                          style: new TextStyle(
                            fontSize: 16.0,
                            // color: Colors.black,
                          ),
                    ...
                    child: RaisedButton(
                      onPressed: () {
                        ...
                        Navigator.of(context)
                            .pushReplacementNamed("/LoginScreen", arguments: {
